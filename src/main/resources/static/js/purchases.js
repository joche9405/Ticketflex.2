...
document.addEventListener('DOMContentLoaded', function() {
    ...
    traditionalPaymentForm.addEventListener('submit', function(e) {
        ...
        const paymentData = {
            cardNumber: document.getElementById('traditionalCardNumber').value,
            expiryDate: document.getElementById('traditionalExpiryDate').value,
            cvv: document.getElementById('traditionalCvv').value,
            cardName: document.getElementById('traditionalCardName').value,
